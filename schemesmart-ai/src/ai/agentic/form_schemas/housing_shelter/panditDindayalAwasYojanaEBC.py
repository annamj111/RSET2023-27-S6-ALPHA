panditDindayalAwasYojanaEBC = {
    "scheme_id": "HOUSING_015",
    "scheme_name": "Pandit Dindayal Upadhyay Awas Yojana (EBC)",
    "form_steps": [
        {
        ...
        {
            "step_id": "community_and_category_details",
            "fields": [
                {
                    "id": "belongs_to_ebc_category",
                    "type": "boolean",
                    "required": True
                },
                {
        ...
        },
        {
            ...
            "fields": [
                ...
                {"id": "land_ownership_proof_uploaded", "type": "boolean", "required": True},
